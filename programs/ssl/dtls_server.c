...
#define SERVER_CRT_PATH "/home/remote/facade.429.crt"
#define SERVER_KEY_PATH "/home/remote/facade.429.key"
#define CA_CERT_PATH "/home/remote/ca_auth.crt"
#define HOST_NAME "facade.429"
...
int main( void )
{
    ...
    ret = mbedtls_x509_crt_parse_file( &srvcert, SERVER_CRT_PATH);
    if( ret != 0 )
    {
        printf( " failed\n  !  mbedtls_x509_crt_parse returned %d\n\n", ret );
        goto exit;
    ...
    ret =  mbedtls_pk_parse_keyfile( &pkey, SERVER_KEY_PATH, NULL);
    if( ret != 0 )
    {
